        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Modification de film</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Modification de film</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">ID du film à modifier</label>
                    <input type="text" class="form-control" name="idMovieToUpdate" id="exampleInputEmail1" placeholder="Entrer l'id">
                  </div>
                  <div class="form-group">
                    <label for="newTitle_ID">Nouveau titre</label>
                    <input type="text" class="form-control" name="newTitle" id="newTitle_ID" placeholder="Entrer le titre">
                  </div>
                </div>
                <!-- /.card-body -->
